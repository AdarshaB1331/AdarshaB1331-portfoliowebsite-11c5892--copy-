  ...
  return (
    <>
      <div id="projects">
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "50px", marginTop: "90px" }}>
          {/* Blog Website Card */}
          <div
            className="card"
            style={{
          ...
          >
            ...
            <div className="card-body">
              ...
              <p
                ...
                className="card-text"
              >
                This is a simple blog application created by me. Feel free to check it out...
              </p>
              <a
          ...
          >
            <img src="aaaaa.png" className="card-img-top" alt="E-commerce Website" />
            <div className="card-body">
              <h5 style={{ marginTop: "40px" }} className="card-title">
                E-commerce Website
              </h5>
              <p
                ...
                className="card-text"
              >
                This is my e-commerce website project where you can explore a range of products and purchase them online.
              </p>
              <a
                style={{ marginTop: "20px" }}
